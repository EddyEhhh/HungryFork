...
class AddressDB {
    ...
    getRestaurantAddress(request, respond) {
        var AddressId = request.params.address_id;
    ...
    updateAddress(request, respond) {
        ...
        var addressObject = new Address(request.params.address_id, request.body.address, request.body.postal_code, request.body.phone,
            request.body.restaurant_googlemap_url, now.toString());
